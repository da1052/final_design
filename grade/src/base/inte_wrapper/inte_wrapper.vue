                    ...
                    <div class="csub">
                      ...
                      <div class="sub_right">
                        <div class="csub_info">
                          ...
                          <div class="info_reply" v-show="item.reply_user != ''">回复&nbsp;&nbsp;{{item.reply_user}}：</div>
                          <div class="reply_text" v-show="item.reply_detail">{{item.reply_detail}}</div>
                          <div class="info_text">{{item.comment_detail}}</div>
                        </div>
                        <div class="sub_icon">
                          <svg class="icon" aria-hidden="true" @click="set_reply(item.commenter, item.comment_detail, item.comment_id)">
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      if(this.login_flag) {
        setTimeout(() => {
          // console.log('content:'+this.$refs.content.offsetHeight);
          // console.log('sub:'+this.$refs.sub.offsetHeight)
          this.$refs.content.style.height = this.$refs.content.offsetHeight > this.$refs.contentp.$el.offsetHeight ? this.$refs.content.offsetHeight : this.$refs.contentp.$el.offsetHeight + 5 + 'px'
        }, 100)
      }
      // console.log('contentp:'+this.$refs.contentp.$el.offsetHeight)
      // this.$refs.content.style.height = this.$refs.content.offsetHeight > this.$refs.contentp.$el.offsetHeight ? this.$refs.content.offsetHeight : this.$refs.contentp.$el.offsetHeight + 5 + 'px'
    },
    created() {
      ...
      this.$http.get('/inte/' + this.data_inte_detail[0].id).then(response => {
        this.comment_list = response.body;
        // this.comment_list = this.comment_list.sort();
