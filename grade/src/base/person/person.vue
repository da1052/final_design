    ...
    <scroll class="person_s" :pulldown="pulldown" :data="data_person">
      <div class="person_g">
        <div class="person_detail">
          ...
          <div class="p_right">
            <input type="tel" v-bind:readonly="isReadOnly" maxlength="3" v-model="age">
          </div>
        </div>
        <div class="person_detail">
        ...
        <div class="person_detail">
          ...
          <div class="p_right">
            <input type="email" v-bind:readonly="isReadOnly" v-model="email">
          </div>
        </div>
        <div class="person_detail">
          <div class="p_left">手机号</div>
          <div class="p_right">
            <input type="number" v-bind:readonly="isReadOnly" v-model="phone">
          </div>
        </div>
